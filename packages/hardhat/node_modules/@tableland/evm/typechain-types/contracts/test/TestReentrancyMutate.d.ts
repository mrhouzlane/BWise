...
export interface TestReentrancyMutateInterface extends utils.Interface {
    functions: {
...
export interface TestReentrancyMutate extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestReentrancyMutateInterface;
...
//# sourceMappingURL=TestReentrancyMutate.d.ts.map