...
export interface TestReentrancyMutateOneInterface extends utils.Interface {
    functions: {
...
export interface TestReentrancyMutateOne extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TestReentrancyMutateOneInterface;
...
//# sourceMappingURL=TestReentrancyMutateOne.d.ts.map