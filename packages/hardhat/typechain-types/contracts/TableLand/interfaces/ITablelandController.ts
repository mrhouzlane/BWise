...
export interface ITablelandControllerInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: "getPolicy(address)" | "getPolicy(address,uint256)"
  ): FunctionFragment;

  encodeFunctionData(
    functionFragment: "getPolicy(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "getPolicy(address,uint256)",
...
export interface ITablelandController extends BaseContract {
  ...
  callStatic: {
    ...
    ): Promise<TablelandPolicyStructOutput>;
